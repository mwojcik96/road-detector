...
def AtrousFCN_Vgg16_16s(input_shape=None, weight_decay=0., batch_momentum=0.9, batch_shape=None, classes=21):
    ...
    # Block 4
    x = Conv2D(256, (3, 3), activation='relu', padding='same', name='block4_conv1', kernel_regularizer=l2(weight_decay))(x)
    ...
    weights_path = os.path.expanduser(os.path.join('./models/model.hdf5'))
